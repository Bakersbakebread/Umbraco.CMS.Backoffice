...
export class UmbAppLanguageContext extends UmbContextBase<UmbAppLanguageContext> {
	...
	constructor(host: UmbControllerHostElement) {
		super(host, UMB_APP_LANGUAGE_CONTEXT_TOKEN);
		this.#languageRepository = new UmbLanguageRepository(host);
