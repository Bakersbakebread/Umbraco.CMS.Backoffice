...
@customElement('umb-checkbox-list-input')
export class UmbCheckboxListInputElement extends FormControlMixin(UmbLitElement) {
	static styles = [
		UUITextStyles,
		css`
			uui-checkbox {
...
export default UmbCheckboxListInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-checkbox-list-input': UmbCheckboxListInputElement;
	}
}
