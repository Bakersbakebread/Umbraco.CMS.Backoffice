...
@customElement('umb-language-input')
export class UmbLanguageInputElement extends FormControlMixin(UmbLitElement) {
	static styles = [
		UUITextStyles,
		css`
			#add-button {
...
export default UmbLanguageInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-language-input': UmbLanguageInputElement;
	}
}
