...
@customElement('umb-template-input')
export class UmbTemplateInputElement extends FormControlMixin(UmbLitElement) {
	/**
...
export default UmbTemplateInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-template-input': UmbTemplateInputElement;
	}
}
