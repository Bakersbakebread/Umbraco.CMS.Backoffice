...
@customElement('umb-slider-input')
export class UmbSliderInputElement extends FormControlMixin(UmbLitElement) {
...
export default UmbSliderInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-slider-input': UmbSliderInputElement;
	}
}
