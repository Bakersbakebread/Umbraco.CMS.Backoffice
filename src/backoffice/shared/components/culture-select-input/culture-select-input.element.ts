...
@customElement('umb-culture-select-input')
export class UmbCultureSelectInputElement extends FormControlMixin(UmbLitElement) {
...
export default UmbCultureSelectInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-culture-select-input': UmbCultureSelectInputElement;
	}
}
