...
@customElement('umb-toggle-input')
export class UmbToggleInputElement extends FormControlMixin(UmbLitElement) {
	static styles = [
		UUITextStyles,
		css`
			uui-toggle {
...
export default UmbToggleInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-toggle-input': UmbToggleInputElement;
	}
}
