...
@customElement('umb-eye-dropper-input')
export class UmbEyeDropperInputElement extends FormControlMixin(UmbLitElement) {
...
export default UmbEyeDropperInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-eye-dropper-input': UmbEyeDropperInputElement;
	}
}
