...
@customElement('umb-number-range-input')
export class UmbNumberRangeInputElement extends FormControlMixin(UmbLitElement) {
...
export default UmbNumberRangeInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-number-range-input': UmbNumberRangeInputElement;
	}
}
