 ...
 */
@customElement('umb-multi-url-input')
export class UmbMultiUrlInputElement extends FormControlMixin(UmbLitElement) {
	static styles = [
		UUITextStyles,
		css`
			uui-button {
...
export default UmbMultiUrlInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-multi-url-input': UmbMultiUrlInputElement;
	}
}
