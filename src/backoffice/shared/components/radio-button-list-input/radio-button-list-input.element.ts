...
@customElement('umb-radio-button-list-input')
export class UmbRadioButtonListInputElement extends FormControlMixin(UmbLitElement) {
	static styles = [
		UUITextStyles,
		css`
			:host {
...
export default UmbRadioButtonListInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-radio-button-list-input': UmbRadioButtonListInputElement;
	}
}
