...
@customElement('umb-upload-field-input')
export class UmbUploadFieldInputElement extends FormControlMixin(UmbLitElement) {
	static styles = [
		UUITextStyles,
		css`
			uui-icon {
...
export default UmbUploadFieldInputElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-upload-field-input': UmbUploadFieldInputElement;
	}
}
